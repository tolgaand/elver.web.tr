/*
  ...
  - You are about to drop the `UsedVerificationCode` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "UsedVerificationCode" DROP CONSTRAINT "UsedVerificationCode_userId_fkey";
...
-- DropTable
DROP TABLE "UsedVerificationCode";
